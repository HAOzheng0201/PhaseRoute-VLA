...
class DiTActionConfig(BaseConfig):
    ...
    """
    text_model_path_url: str = "Qwen/Qwen3-1.7B"
    """ 
    The path or url of the text model.
    """

    vision_model_path_url: str = "google/siglip-so400m-patch14-384"
    """
    ...
    def set_text_model_path_or_url(self,):
        ...
        if self.text_model == "Qwen3-1.7B":
            self.text_model_path_url = "Qwen/Qwen3-1.7B"
        elif self.text_model == "Qwen3-4B":
            self.text_model_path_url = "Qwen/Qwen3-4B"
        elif self.text_model == "Qwen3-0.6B":
            self.text_model_path_url = "Qwen/Qwen3-0.6B"
        elif self.text_model == "SmolLM3-3B":
            self.text_model_path_url = "HuggingFaceTB/SmolLM3-3B"
        elif self.text_model == "SigLip":
            self.text_model_path_url = "google/siglip-so400m-patch14-384"
        else:
