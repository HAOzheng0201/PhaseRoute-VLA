...
run_shard() {
  ...
  while (( $# > 0 )); do
    ...
    case "$1" in
      0|1|2|3)
        cache_args+=(--cache-dir "${repo_root}/reports/m48_teacher_cache_v3_spatial_task$1_1ep_20260802_v1/teacher_calls")
        ;;
      4|5|6|7|8|9)
        cache_args+=(--cache-dir "${repo_root}/reports/m416_teacher_cache_v3_spatial_tasks4_9_1ep_20260803_v1/task$1/teacher_calls")
        ;;
      *)
        echo "unsupported frozen task $1" >&2
        return 4
        ;;
    esac
    shift
